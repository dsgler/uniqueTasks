...
let liclass: liclass = { li_un, li_ed, val_set, add_handler, total, unfinish, finished, footStatus, clear_finished_handler, change_footStatus_handler, remove_item_handler, finish_toggle_handler };
provide("liclass", liclass);
</script>

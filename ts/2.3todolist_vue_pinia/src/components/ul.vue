...
<template>
  <ul class="myul">
    <template v-if="liStore.footStatus !== 'finished'">
      <ul_item v-for="(item, index) in liStore.li_un" :key="item.value" :liNode="item" :index="index" />
    </template>
    <template v-if="liStore.footStatus !== 'unfinish'">
      <ul_item v-for="(item, index) in liStore.li_ed" :key="item.value" :liNode="item" :index="index" />
    </template>
  </ul>
</template>
